...
% Model parameters
T = 25;% Grid size
N =150;% Population size (randomly selected within the given range)
delta1 = 5;% Percentage of initially infected people (randomly selected within the given range)
p = 0.5;% Infection probability in encounter scenario (randomly selected within the given range)
...
w = 0.6;% Second vaccination probability of healthy people [0.4 - 0.8]
