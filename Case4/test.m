...
for i = 1:500
    % Model parameters
    T = 25;% Grid size
    N =300;% Population size (randomly selected within the given range)
    delta1 = 10;% Percentage of initially infected people (randomly selected within the given range)
    p = 0.7;% Infection probability in encounter scenario (randomly selected within the given range)
